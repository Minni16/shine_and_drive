...
<html>
<head>
    <title>CWMS | Premium Treatment Plan</title>
    ...
    <div class="page-container">
        <div class="left-content">
            <div class="mother-grid-inner">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="dashboard.php">Home</a> <i class="fa fa-angle-right"></i> Premium Treatment Plan</li>
                </ol>
                        ...
                        <div class="col-md-12">
                            <div class="plan-description">
                                <div class="plan-header">
                                    ...
                                    <p style="color: #666; font-size: 16px;">Ultimate luxury cleaning with all premium features</p>
                                </div>
                                <div class="plan-features">
                                    <li><i class="fa fa-check-circle"></i> Everything in Standard</li>
                                    <li><i class="fa fa-check-circle"></i> Premium Waxing</li>
                                    <li><i class="fa fa-check-circle"></i> Tire Shine</li>
                                    <li><i class="fa fa-check-circle"></i> Engine Bay Cleaning</li>
                                    <li><i class="fa fa-check-circle"></i> Leather Conditioning</li>
                                    <li><i class="fa fa-check-circle"></i> Premium Air Drying</li>
                                    <li><i class="fa fa-check-circle"></i> Interior Fragrance</li>
                                    <li><i class="fa fa-check-circle"></i> UV Protection Coating</li>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 text-center">
                                            <button type="submit" name="book" class="btn-pay">
                                                <i class="fa fa-lock"></i> Pay Rs 2500 & Complete Booking
                                            </button>
                                        </div>
                                    </div>
                                </form>
