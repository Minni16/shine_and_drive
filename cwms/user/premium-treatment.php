                        ...
                        <div class="col-md-6">
                            <div class="plan-description">
                                ...
                                <div class="plan-features">
                                    ...
                                    <li><i class="fa fa-check-circle"></i> Deep interior cleaning</li>
                                    <li><i class="fa fa-check-circle"></i> Seat shampoo / leather conditioning</li>
                                    <li><i class="fa fa-check-circle"></i> Engine bay cleaning</li>
                                    <li><i class="fa fa-check-circle"></i> Wax or polish coating</li>
                                    <li><i class="fa fa-check-circle"></i> Scratch removal</li>
                                    <li><i class="fa fa-check-circle"></i> AC vent cleaning</li>
                                    <li><i class="fa fa-check-circle"></i> Anti-bacterial interior spray</li>
                                </div>
                            </div>
                        </div>
