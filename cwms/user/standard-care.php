                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="credit-form">
                                ...
                                $failureUrl = $protocol . "://" . $host . $basePath . "/user/standard-care.php";
                                $productId = "PKG2_" . time() . "_" . rand(1000, 9999);
                                ?>
                                <form id="esewa-form" method="POST" action="https://uat.esewa.com.np/epay/main">
                                    <input type="hidden" id="tAmt" name="tAmt" value="3000">
                                    <input type="hidden" id="amt" name="amt" value="3000">
                                    ...
                                    <input type="hidden" name="package_amount" value="3000">
                                    
                                    <div class="form-group">
                                        <label>Package Selected</label>
                                        <input type="text" class="form-control" value="Standard Care - Rs 3000/month" readonly>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label>Total Amount</label>
                                        <input type="text" class="form-control" value="Rs 3000" readonly style="font-size: 24px; font-weight: bold; color: #667eea;">
                                    </div>
